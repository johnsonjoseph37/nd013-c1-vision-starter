...
def split(data_dir):
    ...
    src_file_dir = '/home/workspace/data/waymo/processed/'
	
    file_names = os.listdir(src_file_dir)
    ...
    for i in range(num_files):
        ...
        if i<.8*num_files:
            dst_path = data_dir + 'train/' + file_names[i]

        else:
            dst_path = data_dir + 'val/' + file_names[i]
